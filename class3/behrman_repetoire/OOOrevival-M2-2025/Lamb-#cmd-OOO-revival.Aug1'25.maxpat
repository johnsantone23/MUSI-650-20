...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 857.500025868415833, 439.333346247673035, 134.0, 23.0 ],
					"text" : "surge 0.0275 45. 115."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 1145.977263296650563, 413.000012278556824, 120.0, 23.0 ],
					"text" : "surge 0.03 40. 110."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 994.316618902076243, 420.833345890045166, 135.0, 23.0 ],
					"text" : "surge 0.0225 50. 120."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 342.333343982696533, 427.0, 128.0, 23.0 ],
					"text" : "surge 0.025 60. 120."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 207.182388811729425, 410.333345532417297, 134.0, 23.0 ],
					"text" : "surge 0.0175 50. 110."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 75.250003814697266, 427.0, 135.0, 23.0 ],
					"text" : "surge 0.0225 40. 120."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 53.610428309844906, 770.0, 74.0, 23.0 ],
					"text" : "undu-ASL+",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 311.333343863487244, 787.0, 76.0, 23.0 ],
					"text" : "undu-ASR+",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 164.316671282052994, 747.0, 76.0, 23.0 ],
					"text" : "undu-ASC+",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 526.349972453523492, 302.650009000000011, 49.0, 53.0 ],
									"style" : "redness",
									"text" : "trigger\npitches"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 663.75, 100.072876000000008, 32.0, 25.0 ],
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
									"triangle" : 0,
									"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1198.666702389717102, 41.333334565162659, 54.324633346031078, 44.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 1170.344739674614402, 51.320388495922089, 53.0, 44.0 ],
					"style" : "redness",
					"text" : "incoming\naudio to sensors"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1310.666705727577209, 41.333334565162659, 56.0, 44.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 1270.811408459232325, 51.320388495922089, 56.0, 44.0 ],
					"style" : "redness",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1308.000038981437683, 93.333336114883423, 46.0, 32.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 1267.811408459232325, 106.320388495922089, 46.0, 32.0 ],
					"style" : "redness",
					"text" : "refresh fiddle"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1074.666698694229126, 174.666671872138977, 47.920873088469534, 39.0 ],
					"text" : "X = linked"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 864.666691660881042, 770.0, 75.0, 23.0 ],
					"text" : "undu-DSL+",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 1065.333365082740784, 787.0, 77.0, 23.0 ],
					"text" : "undu-DSR+",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 986.666696667671204, 778.0, 77.0, 23.0 ],
					"text" : "undu-DSC+",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1214.66670286655426, 284.000008463859558, 104.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1031.998345080593026, 238.66667377948761, 108.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 485.0, 20.0, 46.0, 32.0 ],
					"style" : "redness",
					"text" : "timers'duras"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 253.333340883255005, 68.000002026557922, 203.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 224.791625999999951, 100.820403495922051, 206.666672825813293, 50.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.333341240882874, 48.000001430511475, 184.666667461395264, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 224.791625999999951, 76.820403495922051, 184.666667461395264, 23.0 ],
					"style" : "redness",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1117.333366632461548, 37.333334445953369, 45.0, 44.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 1089.699901952316395, 51.320388495922089, 45.0, 44.0 ],
					"style" : "redness",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 223.666676163673401, 386.666678190231323, 114.0, 23.0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "6hits+8v.maxpat",
				"bootpath" : "~/Desktop/GitHub/MUSI-650-20/class3/behrman_repetoire/OOOrevival-M2-2025",
				"patcherrelativepath" : "../../class3/behrman_repetoire/OOOrevival-M2-2025",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
